extends Area2D 
class_name OpacityControllerDEPRECATED
...
func tween_modulate(opacity_controller : OpacityControllerDEPRECATED, sprite: Sprite2D, color : Color, time : float, ease_type: Tween.EaseType):
	if sprite:
